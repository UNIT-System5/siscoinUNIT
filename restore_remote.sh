...
if ! rsync -a --quiet --whole-file --ignore-times --compress-choice=zstd  --compress-choice=zstd -e ssh administrador@192.168.56.201:/home/administrador/backup_device/* /mnt/backup_device 
    then
        ...
        echo "Operación exitosa, recibir respaldos incrementales" >> /root/logs/log.txt
