<?php 
    ...
    class User {
        ...
        public function getRequestssubB($user, $password) {
            $requestSUB = "SELECT *, DATE_FORMAT(fecha_ini_soli, '%d/%m/%Y') AS fecha_ini_soli,
            DATE_FORMAT(fecha_fin_soli, '%d/%m/%Y') AS fecha_fin_soli FROM realiza_soli
        ...
        public function updateEstadoI($user, $password, $fk_estado, $fk_equip) {
        ...
        public function listFP($user, $password) {
            $LFP = "SELECT *, DATE_FORMAT(fecha_ini_fallo, '%d/%m/%Y') AS fecha_ini_fallo,
            DATE_FORMAT(fecha_fin_fallo, '%d/%m/%Y') AS fecha_fin_fallo FROM reporta_fallo
            WHERE estado_fallo = 'Pendiente SubA';";
        ...
        public function listFA($user, $password) {
            $LFA = "SELECT *, DATE_FORMAT(fecha_ini_fallo, '%d/%m/%Y') AS fecha_ini_fallo,
            DATE_FORMAT(fecha_fin_fallo, '%d/%m/%Y') AS fecha_fin_fallo FROM reporta_fallo;";
