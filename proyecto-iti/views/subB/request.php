...
<?php
    if (isset($_SESSION) && !($_SESSION['subB'])) {
        header('Location: ../../');
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="../css/styles_request_subB.css">
...
<body>
    ...
    <div class="container1">
        <div class="bSD">
            <button class="lBtn" title="List All">List All <i class="fas fa-align-left"></i></button>
        </div>
    ...
    <script type="module" src="../js/request_subB.js"></script>
</body>
</html>