                ...
                <fieldset>
                    ...
                    <div class="selectReq">
                        <select name="reqSol" class="reqSol" required>
                            <option id="firstO" value="default" disabled selected>Select a Request</option>
                            ${lSol}
                        </select>
                    </div>
                    <div class="selectType">
                        <select name="typeSol" class="typeReq" disabled required>
                            <option value="default" disabled selected>Equipment Type</option>
                        </select>
                    </div>
                    <div class="selectProv">
                        <select name="provS" class="provSol" required>
                            <option value="default" disabled selected>Select a Provider</option>
                            ${lProv}
                        </select>
                    </div>
                    <div class="inpGroup">
                        ...
                        <div class="selectPur">
                            <select name="purchSol" class="purchReq" required>
                                <option value="default" disabled selected>Purchase Type</option>
