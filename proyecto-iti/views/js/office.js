        ...
        lDeparts().done((data) => {
            ...
            let offContainer = `<div class="offContainer">
                <form action="../../init.php" method="POST" id="offForm" autocomplete="off">
                    ...
                    <fieldset>
                        <input type="text" class="nomOff" placeholder="Insert Office Name" required
                        ...
                        <input type="text" class="dirOff" required placeholder="Insert Address"
                        ...
                        <input type="text" class="cityOff" required placeholder="Insert City"
                        minlength="1" maxlength="40">
                        <input type="tel" required placeholder="Insertar Phone"
