    ...
    call.done((data) => {
        ...
        data.forEach((d) => {
            ...
            lTr += `<tr>
                ...
                `<i title="Send to Guarantee" id="${d.id_equip}"
...
function scrapEquip(id, equip) {
    ...
    $.post('../../init.php', {
        ...
        scrapContainer = `<div class="scrapContainer">
            <form action="../../init.php" method="POST" id="addScrapF"></form>
            <form action="../../init.php" method="POST" id="scrapForm" autocomplete="off">
                ...
                <button class="addTL" form="addScrapF" type="submit">Add <i class="fas fa-plus"></i></button>
                <button class="subTL" type="submit"><i class="fas fa-paper-plane"></i></button>
            </form>
        </div>`;
...
$('body').on('click', '.actions .fa-shield-alt', function() {
    let id = $(this).attr('id');
...
$('body').on('submit', '#addScrapF', function(e) {
    e.preventDefault();
