            ...
            <div class="history_tab">
                <table>
                    <tr class="top-tr">
                        ...
                        <th class="tit_col"><i class="fas fa-quote-right"></i> Título</th>
                        <th class="desc_col"><i class="fas fa-align-left"></i> Descripción</th>
                        <th class="lugar_col"><i class="fas fa-building"></i> Oficina</th>
                        <th class="tipo_col"><i class="fas fa-equip"></i> Tipo Equipamiento</th>
                        <th class="fecha_col"><i class="far fa-calendar"></i> Fecha Inicial</th>
                        <th class="fehca_col_2"><i class="far fa-calendar-alt"></i> Fecha Final</th>
                    </tr>
                </table>
